		...
		for (day in upcommingDays) {
			...
			if (this.config.timeFormat === "dateheaders") {
				if (lastSeenDate !== dateAsString) {
					...
					dateRow.className = "normal specular-normal";

					//var header = document.createElement("td");
					//header.id = "specular-header";
					let specularDiv = document.createElement("div");
					specularDiv.id = "specular-header";

					let roundedDiv = document.createElement("div");
					roundedDiv.className = "rounded-day";
					var dateCell = document.createElement("p");
					dateCell.colSpan = "3";
					dateCell.innerHTML = this.capFirst(dateAsString);
					roundedDiv.appendChild(dateCell);

					var dateCell1 = document.createElement("p");
					dateCell1.colSpan = "3";
					dateCell1.innerHTML = parseInt(this.capFirst(dateAsString)) - 2;

					var dateCell2 = document.createElement("p");
					dateCell2.colSpan = "3";
					dateCell2.innerHTML = parseInt(this.capFirst(dateAsString)) - 1;

					var dateCell3 = document.createElement("p");
					dateCell3.colSpan = "3";
					dateCell3.innerHTML = parseInt(this.capFirst(dateAsString)) + 1;

					var dateCell4 = document.createElement("p");
					dateCell4.colSpan = "3";
					dateCell4.innerHTML = parseInt(this.capFirst(dateAsString)) + 2;

					specularDiv.appendChild(dateCell1);
					specularDiv.appendChild(dateCell2);
					specularDiv.appendChild(roundedDiv);
					specularDiv.appendChild(dateCell3);
					specularDiv.appendChild(dateCell4);
					//dateRow.appendChild(header);
					//col.appendChild(dateRow);
					wrapper.appendChild(specularDiv);
